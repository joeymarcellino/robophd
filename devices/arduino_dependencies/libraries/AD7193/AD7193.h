...
public:
	...
	void SetSincFilter(int sinc);

	void SetChannels(unsigned long channel);

	void SetContinousConversionMode(void);
	
	unsigned long ReadADCChannelsData(void);

	void ReadRegisterMap(void);

	void SetContinousReadMode(void);
