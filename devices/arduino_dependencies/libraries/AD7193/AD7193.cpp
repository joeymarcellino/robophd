...
void AD7193::WaitForADC(void)  {
    ...
    while(1){
      ...
      if (breakTime > 3000000) {                       // Break after some seconds - avoids program hanging up
...
void AD7193::SetChannels(unsigned long channels) {
...
void AD7193::SetContinousConversionMode(void) {
  ...
  // Set Mode register to Continous Conversion Mode
  registerMap[1] &= 0x0FFFFF; 
  registerMap[1] |= 0x100000; 
  SetRegisterValue(1, registerMap[1], 3, 0);
}

void AD7193::SetContinousReadMode(void) {
