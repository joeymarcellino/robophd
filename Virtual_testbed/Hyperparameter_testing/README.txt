Fig.2: virtual_testbed_main_paper_plots (algorithm_preparation (for algorithm80), diff_obs_preparation for preparation, ./algorithm80/,./diff_obs/ for logs needeed)
