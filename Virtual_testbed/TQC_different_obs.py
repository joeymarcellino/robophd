...
def main():
    ...
    for _ in range(5):
        for obs_P_ave in [True, False]:
            for obs_P_max, obs_x_max in [[True, True], [False, False]]:
                env = Env_fiber_simulated_diff_obs(max_actioninsteps, minmirrorintervalsteps, maxmirrorintervalsteps,
                                  ...
                                  min_power_after_reset, max_power_after_reset, min_power, reset_method,
                                              ...
                                              timestamp=None,
                                              random_reset=True, dir_names="diff_obs", save_replay=True,
                                                                 obs_P_ave=obs_P_ave, obs_P_max=obs_P_max, obs_x_max=obs_x_max)
                env.reset()
