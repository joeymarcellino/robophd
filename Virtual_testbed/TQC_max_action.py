...
def main():
    ...
    prefactor_goal = 100
    prefactor_fail = 100
    # test different max. actions
    for _ in range(5):
        for max_actioninsteps in [2*10**3, 4*10**3, 5*10**3, 6*10**3, 7*10**3, 8*10**3, 9*10**3, 10**4]:
            ...
            def reward_fct_2024_04_22(avg_power, max_power, power, reset_power_fail, max_episode_steps,
                ...
                return reward
            dir_names = f"max_action_tests/max_action{max_actioninsteps}"
